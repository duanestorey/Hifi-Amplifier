...
public:
    AmplifierState() : mAudioType( AUDIO_ANALOG ), mState( STATE_INIT ), mInput( INPUT_6CH ), mSpeakerConfig( AUDIO_5_DOT_1 ), mCurrentVolume( 65 ), mSamplingRate( 48000 ), mConnected( false ) {}
