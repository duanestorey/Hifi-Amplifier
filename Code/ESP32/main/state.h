...
public:
    AmplifierState() : mAudioType( AUDIO_ANALOG ), mState( STATE_INIT ), mInput( INPUT_6CH ), mSpeakerConfig( AUDIO_5_DOT_1 ), mCurrentAttenuation( 20 ), mSamplingRate( 48000 ), mConnected( false ), mEnhancement( false ) {}
