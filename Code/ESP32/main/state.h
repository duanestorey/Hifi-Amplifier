...
public:
    AmplifierState() : mAudioType( AUDIO_ANALOG ), mState( STATE_INIT ), mInput( INPUT_STEREO_2 ), mSpeakerConfig( AUDIO_5_DOT_1 ), mCurrentVolume( 55 ), mSamplingRate( 48000 ), mConnected( false ) {}
