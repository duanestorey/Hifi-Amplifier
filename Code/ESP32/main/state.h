...
public:
    AmplifierState() : mAudioType( AUDIO_DOLBY ), mState( STATE_INIT ), mInput( INPUT_6CH ), mSpeakerConfig( AUDIO_5_DOT_1 ), mCurrentVolume( 68 ), mSamplingRate( 48000 ), mConnected( false ) {}
