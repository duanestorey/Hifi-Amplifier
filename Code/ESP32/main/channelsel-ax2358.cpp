...
#define         AX2358_VOL_ALL_10           0b11100000
#define         AX2358_VOL_ALL_1            0b11010000
...
ChannelSel_AX2358::setChannelVolume( uint8_t channel, uint8_t volume ) {
    ...
    uint8_t onesDigit = negVol & 0x0f;
    uint8_t tensDigit = negVol & 0x07;
    ...
    switch( channel ) {
        case ChannelSel::CHANNEL_FRONT_LEFT:
            ...
            mI2C->writeBytes( mAddress, data, 2 );
            break;
