...
#define LED_INPUT_6CH_Pin GPIO_PIN_10
#define LED_INPUT_6CH_GPIO_Port GPIOB
...
#define DECODER_RESET_Pin GPIO_PIN_10
#define DECODER_RESET_GPIO_Port GPIOC
#define DECODER_IRQ_Pin GPIO_PIN_11
